...
; === Stage 2. Data of 16-bit real mode === ;
...
lmode_entry:
    ...
    mov rsi, str_64_bit_kernel_load
    mov ah,  0x0A 
    call print_lmode
...
; === data of 32-bit protected mode and 64-bit long mode. Stage 2 === ;
...
; --- Errors --- ;
str_error:        db "[DBL ERROR]: No Long Mode!", 13, 10, 0
